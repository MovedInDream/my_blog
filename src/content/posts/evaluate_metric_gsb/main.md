...
在视频生成领域，像 Google 的 [Veo3](https://deepmind.google/models/veo/)，字节跳动 的 [Seedance](https://seed.bytedance.com/zh/seedance2_0)，或是 xAI 最近发布的 [Grok Imagine](https://x.ai/news/grok-4)  等模型的发布， GSB(Good/Same/Bad) 指标通常是Release note中不可或缺的一部分，成为佐证模型能力（打压竞争对手模型）最直观的证据。
